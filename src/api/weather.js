...
var options = {
	'method': 'GET',
	'url': 'http://api.agromonitoring.com/agro/1.0/image/search?start='+start+'&end='+end+'&polyid='+polyid+'&appid=fa22c15b2ec8bc88d3655480ab5ee305',
	'headers': {
	}
	};
...
var options = {
	'method': 'GET',
	'url': 'http://api.openweathermap.org/data/2.5/weather?lat='+lat+'&lon='+lon+'&appid=6af62b6820f3d797f057348fdad9eaa1',
	'headers': {
	}
	};
	request(options, function (error, response) {
...
var options = {
	'method': 'POST',
	'url': 'http://api.agromonitoring.com/agro/1.0/polygons?appid=fa22c15b2ec8bc88d3655480ab5ee305',
	'headers': {
...
const getFarmWeather = (coordinates,start,end,lat,lon,callback) =>{
var poly = null;
